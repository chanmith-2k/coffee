...
const nurseryData = {
  ...
  phone: "078 281 8230",
  location: "166/D Harangala Road, Hapugasthalawa, 20668",
  plants: [
  {
    name: "Arabica S9",
    desc: "Selection 9 යනු උසස් Arabica hybrid කෝපි වර්ගයකි. Leaf Rust වැනි රෝගවලට වඩා හොඳ ඉවසීමක්, හොඳ අස්වැන්නක් සහ premium aroma profile එකක් ලබාදීමට සුදුසු වර්ගයකි.",
    tag: "උසස් Arabica hybrid",
    price: "රු. 50 සිට",
  },
  {
    name: "Lakperakum",
  ...
  },
  {
    ...
    desc: "Robusta කෝපි පැළ උණුසුම් ප්‍රදේශවලට සහ ශක්තිමත් වර්ධනයක් අවශ්‍ය වගා සඳහා සුදුසුයි. ආරම්භක වගාකරුවන්ටත් පහසු වර්ගයකි.",
    tag: "ශක්තිමත් වර්ධනය",
    price: "රු. 15 සිට",
  },
],
  ...
  },
  {
    size: "මාස 6 පැළ",
    price: "රු. 50",
    note: "Arabica S9 සහ Lakperakum වර්ග සඳහා ලබාගත හැකි පැළ.",
  },
  {
    size: "අවුරුදු 2 පැළ",
    price: "රු. 999",
